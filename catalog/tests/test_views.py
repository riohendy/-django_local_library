...
class AuthorCreateTest(TestCase):
    ...
    def test_add_author_redirect_if_no_permission_exists(self):
        #Log in our bad user and confirm he is logged in
    ...
    def test_add_author_view_url_exists_at_desired_location(self):
        resp = self.client.get('/catalog/author/create/') 
        self.assertEqual(resp.status_code, 302) 

    def test_author_has_initial_date_set(self):
        login = self.client.login(username='testuser1', password='12345')
        resp = self.client.get(reverse('author_create'))
        self.assertEqual( resp.status_code,200)
        
        test_author = Author.objects.create(first_name='John', last_name='Smith',)
        date_of_death = test_author.date_of_death
